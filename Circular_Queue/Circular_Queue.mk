...
ProjectPath            :=C:/Users/ASUS/OneDrive/Documents/My_programmes/Circular_Queue
...
../build-$(ConfigurationName)/Circular_Queue/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/Circular_Queue/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/ASUS/OneDrive/Documents/My_programmes/Circular_Queue/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
